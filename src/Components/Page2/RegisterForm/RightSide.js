...
function RightSide() {
    ...
    return (
    <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12 bg-white">
      <form className="p-6 lg:p-8 pl-2 pr-2 md:pl-6 md:pr-6 lg:pl-8 lg:pr-8 xl:pl-8 xl:pr-8">
        {/* <!--Sign in section--> */}
        ...
        <p className="font-sans text-xs">I am in :</p>
        <TESelect data={designation} size="lg" className="mb-6" />
        ...
        <p className="font-sans text-xs">
          Using your mobile phone number, we can confirm your identity when you
          login into your account or contact you if any suspecious activity is
        ...
        ></TEInput>
        <p className="font-sans text-xs">
          Use 8 or more charchters with a mix of letters, numbers and symbols.{" "}
        </p>
        {/* <!--Password input--> */}
        <TEInput
          type="password"
          ...
          size="lg"
        ></TEInput>
        <p className="mb-4 font-sans text-base font-bold">
          What amourt are you considering investing in startups over the next 12
          months ?
        </p>
        <TESelect
          label="Please select a reply"
          data={amount}
          className="mb-6"
        />
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
            ...
            >
              ...
              understood the terms and conditions.” Using a clickwrap method may
              better protect a business because a user must take proactive
              measures to agree to terms and conditions
            </label>
          </div>
