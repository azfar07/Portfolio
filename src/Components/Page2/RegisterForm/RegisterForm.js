          ...
          <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
            <form>
              ...
              <p className="font-sans text-xs">
                Using your mobile phone number, we can confirm your identity
                when you login into your account or contact you if any
                suspecious activity is detected in your account.
              </p>
              {/* <!--Password input--> */}
              <TEInput
                type="password"
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                  ...
                  >
                    ...
                    method may better protect a business because a user must
                    take proactive measures to agree to terms and conditions
                  </label>
                </div>
